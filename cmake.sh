...
cmake . -DCMAKE_INSTALL_PREFIX=~/opt/spring -Bbuild -DCMAKE_BUILD_TYPE=Debug -DCMAKE_EXPORT_COMPILE_COMMANDS=1 -DDEBUG_MAX_WARNINGS=0 -DDEBUG_SIGNAL_NANS=0 # -DLOG_LEVEL=$LOG_LEVEL
# pushd build
